...
\label{award:skill}
The @Home league features certificates for the robots best at the key concepts that have been agreed upon the TC and EC (see \refchap{chap:stage_I} for the complete list).
  
A team is given a certificate if it scored at least 75\% of the attainable points for that skill and is agreed upon the TC and EC.
This is counted over all tests and challenges, so e.g. if the robot scores manipulation points during a \iterm{Stage~I} test to open the door, that will count for the Manipulation-certificate.
...
\subsection{RoboCup Design Award}
\label{award:design}
Flower Robotics and the RoboCup Federation introduced an award, called the \quotes{RoboCup Design Award}, to encourage research and education to focus on the importance of the design of robots. And, we continue the award for this year. Robots and/or technologies will be awarded that are well-designed not only for their performance but also for their simpleness, easiness, smoothness in daily operation and other usages. We believe that the award will promote the popularity of robotics in wider fields.
